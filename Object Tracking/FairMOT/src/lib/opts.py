...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='IDD', help='IDD')
    ...
    self.parser.add_argument('--test_gram', default=False, help='GRAM data')
    ...
    self.parser.add_argument('--input-video', type=str,
                             default='/data/home/anujkumar1/DeepTraffic/Fairmot/videos/iisc_bridge.mp4',
                             help='path to the input video')
    self.parser.add_argument('--output-format', type=str, default='video', help='video or text')
    self.parser.add_argument('--output-root', type=str, default='/data/home/anujkumar1/DeepTraffic/Fairmot/demos/', help='expected output root path')

    # mot
    self.parser.add_argument('--data_cfg', type=str,
                             default='../src/lib/cfg/IDD.json',
                             help='load data from cfg')
    self.parser.add_argument('--data_dir', type=str, default='/data/home/anujkumar1/DeepTraffic/Object Tracking/FairMOT/IDD')
